...
return [
    ...
    */
    ...
    'support_url' => env('STATAMIC_SUPPORT_URL', 'https://github.com/sosaheri'),
    ...
    */
    ...
    'custom_cms_name' => env('STATAMIC_CUSTOM_CMS_NAME', 'NutriMED'),

    'custom_logo_url' => env('STATAMIC_CUSTOM_LOGO_URL', 'images/header-logo/logo.png'),

    'custom_favicon_url' => env('STATAMIC_CUSTOM_FAVICON_URL', 'images/header-logo/logo.png'),
